...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case minion:
		myMinionCard(choice1, choice2, state, handPos, currentPlayer);
    ...
    case tribute:
		myTributeCard(choice1, choice2, state, handPos, currentPlayer, nextPlayer);
		
    case ambassador:
		myAmbassadorCard(choice1, choice2, state, handPos, currentPlayer);
